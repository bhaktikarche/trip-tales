...
function MyAccount() {
  ...
  const averageEngagement =
    userPosts.length > 0 ? (totalLikes + totalHelpfuls) / userPosts.length : 0;
  ...
  // Fetch messages - UPDATED to use the correct endpoint
  ...
  // Send message - UPDATED to use the correct endpoint
    ...
    <div className="container py-4">
      ...
      >
        ...
        <Modal.Body className="tt-modal-body">
          <p className="tt-modal-prompt">
            How has your journey with our app been?
          </p>
          <textarea
          ...
          <div className="tt-feedback-note">
            Your insights help us create better adventures for travelers
            worldwide.
          </div>
        </Modal.Body>
      ...
      {displayedPosts.length === 0 ? (
        <p>
          {showingBookmarks ? "No bookmarked posts." : "You have no posts."}
        </p>
      ) : showingBookmarks ? (
                  ...
                  {conversations.map((conv) => (
                    ...
                    >
                      <div className="d-flex justify-content-between align-items-center">
                        <span
                          className={
                            selectedConversation === conv.id ? "text-white" : ""
                          }
                        >
