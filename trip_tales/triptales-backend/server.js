...
function authenticateAdmin(req, res, next) {
  ...
  try {
    const jwtSecret = process.env.JWT_SECRET || 'fallback_secret_key_for_testing';
...
const initializeApp = async () => {
  ...
  app.get('/api/admin/chats/:chatId/messages', authenticateAdmin, async (req, res) => {
    try {
  ...
  // Block a user
  app.post('/api/admin/block-user/:userId', authenticateAdmin, async (req, res) => {
    try {
      const { userId } = req.params;
  ...
  // Unblock a user
  app.post('/api/admin/unblock-user/:userId', authenticateAdmin, async (req, res) => {
    try {
      const { userId } = req.params;
